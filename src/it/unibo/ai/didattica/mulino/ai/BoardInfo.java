...
public class BoardInfo {
	...
	private int value;
	private ByteAction bestMove;
	private ByteAction secondBestMove;
	private int type;
	private int depth;
	private int secondMoveDepth;

	public BoardInfo(int value, ByteAction move, int type, int depth) {
		this.value = value;
		this.bestMove = move;
		this.type = type;
		this.depth = depth;
	...
	public ByteAction getSecondBestMove() {
		return secondBestMove;
	}

	public ByteAction getBestMove() {
		return bestMove;
	}
	...
	// the best move.
	public void updateInfo(int value, ByteAction move, int type, int depth) {
